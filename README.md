...
It provides a simple Web interface to enable configuration of the ESP32/LED/Rumble Motor/Audio, change settings, and write NFC tag/Cards with extned information to hold game lauch and tag/card removal audio file paths.
